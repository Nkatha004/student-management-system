...
<head>
    ...
    <link href = "{{URL::asset('css/indexTrial.css')}}" rel = "stylesheet">  
</head>
<body class = "stop-scrolling">
        ...
        <div class = "big-wrapper light">
            ...
            <header>
                <div class="container">
                    ...
                    <div class="links">
                        <ul>
                            <li><a href="{{ URL::to('/logintrial') }}" class = "btn">Sign up</a></li>
                        </ul>
                    </div>
            ...
            <div class="showcase-area">
                <div class="container">
                    <div class="left">
                        ...
                        <div class="cta">
                            <a href="{{ URL::to('/logintrial')}}" class="btn">Get Started</a>
                        </div>
                    </div>
                    <div class="right">
    ...
    <script src = "{{ URL::asset('js/indexTrial.js') }}"></script>
</body>
</html>